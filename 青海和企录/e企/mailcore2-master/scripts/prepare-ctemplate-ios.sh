...
if xcodebuild -showsdks|grep iphoneos8.3 >/dev/null ; then
    sdkversion=8.3
    MARCHS="armv7 armv7s arm64"
elif xcodebuild -showsdks|grep iphoneos8.2 >/dev/null ; then
  sdkversion=8.2
    MARCHS="armv7 armv7s arm64"
elif xcodebuild -showsdks|grep iphoneos8.1 >/dev/null ; then
	sdkversion=8.1
    MARCHS="armv7 armv7s arm64"
