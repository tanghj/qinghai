...
- (NSString *)formatLogMessage:(DDLogMessage *)logMessage
{
    ...
    NSString* file = [[[NSString stringWithUTF8String:logMessage->file] stringByAppendingPathComponent:@"/"] lastPathComponent];
    return [NSString stringWithFormat:@"%@ [%d:%d][%@:%d][%s] %@", dateAndTime, (int)getpid(), logMessage->machThreadID, file, logMessage->lineNumber, logMessage->function, logMessage->logMsg];
}
