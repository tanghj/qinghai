...
@interface TKContactsMultiPickerController : UIViewController <UITableViewDataSource, UITableViewDelegate, UISearchDisplayDelegate, UISearchBarDelegate,UIActionSheetDelegate,UIAlertViewDelegate>
{
	id _delegate;
    TKAddressBook *_selectAddressBook;
    UIButton *_leftButt;
...
@property(strong, nonatomic) ABUnknownPersonViewController* controller2;
