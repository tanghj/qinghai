...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if(indexPath.section==0){
        ...
        UIView *linebon2=[[UIView alloc]initWithFrame:CGRectMake(0, 55.5, 320, 0.5)];
        linebon2.backgroundColor=[UIColor colorWithRed:220/255.0 green:220/255.0 blue:220/255.0 alpha:1];
        [cell addSubview:linebon2];
        ...
        UIView *linebon2=[[UIView alloc]initWithFrame:CGRectMake(0, 43.5, 320, 0.5)];
        linebon2.backgroundColor=[UIColor colorWithRed:220/255.0 green:220/255.0 blue:220/255.0 alpha:1];
        [cell addSubview:linebon2];
