...
@interface RYVideoCompress(){
    NSURL *_urlVedioCaches;
}

@end

@implementation RYVideoCompress
...
{
    if (self=[super init]) {
        NSString *vedioCachesPath=[NSTemporaryDirectory() stringByAppendingPathComponent:@"andron_video/vediocaches.MOV"];
        //判断目录是否存在不存在则创建
